...
def stream_data(response):
    for word in response.split(" "):
        yield word + " "
        time.sleep(0.02)
template = "You are a conversational chatbot created by Sanjeet Jangid.you have to give response of user chats only and next sentence is user's chat. 'user query' = "
